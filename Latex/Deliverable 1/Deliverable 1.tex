...
\begin{figure}[!htb]
	\centering
	\fbox{\includegraphics[width=18cm,height=18cm]{Use_Case_Diagrams/MindMap_TVM.jpg}}
	\caption{Mind Map}
	\label{fig: mind_map}
\end{figure}
...
\begin{figure}[!htb]
	\fbox{\includegraphics[width=18cm, height=18cm]{Use_Case_Diagrams/UseCaseModel.jpeg}}
...
\begin{longtable}{!{\color{blue}\vrule width 5pt} p{0.4\linewidth} | p{0.15\linewidth} | p{0.2\linewidth} !{\color{blue}\vrule width 5pt} }
	...
	\multicolumn{3}{!{\color{blue}\vrule width 5pt} p{0.9\linewidth} !{\color{blue}\vrule width 5pt}}{\textbf{Usability-2:} by using a screen reader for vision impaired users or people who cannot read or write.} \\ 
