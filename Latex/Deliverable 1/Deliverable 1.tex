...
\begin{figure}[!htb]
	\centering
	\fbox{\includegraphics[width=9cm,height=10.5cm]{domain_model.png}}
...
\begin{figure}[!htbp]
	...
	\caption{\label{fig:Activity Diagram : } Password Reset}	
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption{\label{fig:Sequence Diagram : } Buy Ticket}	
\end{figure}
...
\begin{figure}[!htbp]
	...
	\caption{\label{fig:Activity Diagram : } Buy Ticket}	
\end{figure}
